...
const PACKAGES = {
  basic: {
    label: "Basic", maxProducts: 5, revisions: 1, color: "#4a9eff",
    includes: ["SEO title", "Meta description", "Short description", "1 revision"]
  },
  standard: {
    label: "Standard", maxProducts: 10, revisions: 2, color: "#c8f564",
    includes: ["SEO title", "Meta description", "Short description", "5 bullet points", "2 revisions"]
  },
  premium: {
    label: "Premium", maxProducts: 10, revisions: 3, color: "#ff9f43",
